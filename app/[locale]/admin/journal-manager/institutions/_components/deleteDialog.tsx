...
import { deleteInstitution } from '@/lib/books/institution'
import { AlertTriangle, Loader2, Trash2, X } from 'lucide-react'
import { useState } from 'react'
import { toast } from 'sonner'

export function DeleteIntitutionDialog({
	id,
	institutionname,
	open,
	onOpenChange,
	...
	const handleDelete = async () => {
		try {
			...
			toast.success(`${institutionname} muvaffaqiyatli o'chirildi`)
			onOpenChange(false)
			onSuccess()
		} catch (error) {
			toast.error(`Muassasa o'chirishda xatolik: ${error}`)
		} finally {
			setLoading(false)
		}
	}
